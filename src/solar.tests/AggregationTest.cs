...
public class AggregationTest
{
    ...
    public void TestNoExceptionReadingOldCsvs()
    {
        ...
        var files = CsvAggregate<PowerData, DayPowerData>.GetFilesInFolder(new DirectoryInfo(@"..\..\..\..\..\target\etc\db"), FsTimeSeries<PowerData, DayPowerData>.FILENAME_FORMAT, DateTime.Now);
