...
//                    if (ack != ErrorCode.Ok)
//                    {
//                        ConsoleLogger.Log("Bad Init response at " + this + ": " + ack);
//                    }
...
//                    if (ack != ErrorCode.Ok)
//                    {
//                        ConsoleLogger.Log("Bad EnableSdi response at " + this + ": " + ack);
//                    }
...
//                    if (ack != ErrorCode.Ok)
//                    {
//                        ConsoleLogger.Log("Bad SetVolume response at " + this + ": " + ack);
//                    }
//                }
...
//                if (ack != ErrorCode.Ok)
//                {
//                    ConsoleLogger.Log("Bad StreamResponse response at " + this + ": " + ack);
//                    return;
//                }
...
//                    {
//                        ConsoleLogger.Log("Bad StreamResponse response at " + this + ": " + resp.Result);
//                        return;
//                    }
//                    HighConsole.WriteLine("OK");
...
//                if (ack != ErrorCode.Ok)
//                {
//                    ConsoleLogger.Log("Bad response SetVolumeMessage at " + this + ": " + ack);
//                    return false;
//                }
//            }
//            return true;
