...
class PollStrategyManager(ILogger<PollStrategyManager> logger) : BackgroundService
{
    ...
    public NightState NightState
    {
        ...
        set
        {
            ...
            {
                nightState = value;
                logger.LogInformation("NightState: " + value);
            }
        }
    }
    ...
    private void SetLastCommunicationError(CommunicationError value)
    {
        ...
        {
            logger.LogInformation("InvertCommErr: value {0} from {1}", value, _lastCommunicationError);
