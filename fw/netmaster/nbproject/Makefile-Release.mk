...
${OBJECTDIR}/_ext/d2a1ad61/apps.o: ../apps/apps.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -D_CONF_RASPBIAN -D__USE_BSD -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d2a1ad61/apps.o ../apps/apps.c
...
${OBJECTDIR}/_ext/d2a1ad61/dcf77.o: ../apps/dcf77.c
	${MKDIR} -p ${OBJECTDIR}/_ext/d2a1ad61
	${RM} "$@.d"
	$(COMPILE.c) -O2 -D_CONF_RASPBIAN -D__USE_BSD -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d2a1ad61/dcf77.o ../apps/dcf77.c

${OBJECTDIR}/_ext/d2a1ad61/flasher.o: ../apps/flasher.c
	${MKDIR} -p ${OBJECTDIR}/_ext/d2a1ad61
	${RM} "$@.d"
	$(COMPILE.c) -O2 -D_CONF_RASPBIAN -D__USE_BSD -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d2a1ad61/flasher.o ../apps/flasher.c

${OBJECTDIR}/_ext/d2a1ad61/spiram.o: ../apps/spiram.c
	${MKDIR} -p ${OBJECTDIR}/_ext/d2a1ad61
	${RM} "$@.d"
	$(COMPILE.c) -O2 -D_CONF_RASPBIAN -D__USE_BSD -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/d2a1ad61/spiram.o ../apps/spiram.c
...
${OBJECTDIR}/_ext/828e6f31/dht11.o: ../sinks/dht11.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -O2 -D_CONF_RASPBIAN -D__USE_BSD -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/828e6f31/dht11.o ../sinks/dht11.c

${OBJECTDIR}/_ext/828e6f31/digio.o: ../sinks/digio.c
	${MKDIR} -p ${OBJECTDIR}/_ext/828e6f31
	${RM} "$@.d"
	$(COMPILE.c) -O2 -D_CONF_RASPBIAN -D__USE_BSD -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/828e6f31/digio.o ../sinks/digio.c

${OBJECTDIR}/_ext/828e6f31/displaySink.o: ../sinks/displaySink.c
	${MKDIR} -p ${OBJECTDIR}/_ext/828e6f31
	${RM} "$@.d"
	$(COMPILE.c) -O2 -D_CONF_RASPBIAN -D__USE_BSD -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/828e6f31/displaySink.o ../sinks/displaySink.c

${OBJECTDIR}/_ext/828e6f31/halfduplex.o: ../sinks/halfduplex.c
	${MKDIR} -p ${OBJECTDIR}/_ext/828e6f31
	${RM} "$@.d"
	$(COMPILE.c) -O2 -D_CONF_RASPBIAN -D__USE_BSD -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/828e6f31/halfduplex.o ../sinks/halfduplex.c
